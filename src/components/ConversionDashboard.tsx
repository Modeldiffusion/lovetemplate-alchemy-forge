...
export const ConversionDashboard = () => {
  ...
  // Mock data for conversion jobs
  const [jobs, setJobs] = useState<ConversionJob[]>([
    {
      id: "1",
      templateName: "Legal Contract Template v2.1",
      sourceFormat: "PDF",
      targetFormat: "DOCX",
      status: "processing",
      progress: 67,
      ...
      inputTags: ["contract", "legal", "terms"],
      outputTags: ["agreement", "legal-doc", "conditions"],
    ...
    },
    {
      ...
      inputTags: ["invoice", "billing", "payment"],
      outputTags: ["bill", "payment-request", "financial"],
      previewAvailable: true
    },
    {
      id: "3",
      templateName: "Employee Handbook 2024",
      sourceFormat: "TXT",
      targetFormat: "DOCX",
      status: "failed",
      progress: 23,
      startTime: "1 hour ago",
      inputTags: ["policy", "hr", "handbook"],
      outputTags: [],
      errorMessage: "Unsupported character encoding detected",
      previewAvailable: false
    },
    {
      id: "4",
      templateName: "Project Proposal Template",
      sourceFormat: "PDF",
      targetFormat: "DOCX",
      status: "queued",
      progress: 0,
      startTime: "5 min ago",
      inputTags: ["proposal", "project", "business"],
      outputTags: [],
      previewAvailable: false
    }
  ]);
  ...
  const templates: ConversionTemplate[] = [
    {
      ...
      description: "High-quality conversion preserving formatting and structure",
      sourceFormat: "PDF",
      targetFormat: "DOCX",
      rules: ["Preserve formatting", "Extract images", "Maintain structure"],
      successRate: 94.5,
      avgProcessingTime: "2.3 min"
    },
    {
      id: "2",
      name: "Contract Standardizer",
      description: "Converts legal documents to standard format with tag mapping",
      sourceFormat: "Any",
      targetFormat: "DOCX",
      rules: ["Legal term mapping", "Standard clauses", "Compliance check"],
      successRate: 97.2,
      avgProcessingTime: "3.7 min"
    },
    {
      id: "3", 
      name: "Multi-format Processor",
      description: "Universal converter supporting multiple input and output formats",
      sourceFormat: "Multiple",
      targetFormat: "Multiple",
      rules: ["Format detection", "Smart conversion", "Quality preservation"],
      successRate: 89.8,
